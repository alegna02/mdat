...
pred_Mujere_SinSexo.rf=predict(Datos_con_Factores_SinSexo.rf, Datos_Test_con_Factores_Mujeres[,-c(15)])
table.pred_Mujere_SinSexo.rf=table(pred_Mujere_SinSexo.rf,  as.factor(Datos_Test_con_Factores_Mujeres[,15]))
print(table.pred_Mujere_SinSexo.rf)


pred_Mujere.rf=predict(Datos_con_Factores.rf, Datos_Test_con_Factores_Mujeres[,-c(15)])
table.pred_Mujere.rf=table(pred_Mujere.rf,  as.factor(Datos_Test_con_Factores_Mujeres[,15]))
print(table.pred_Mujere.rf)
...
pred_Hombre.rf=predict(Datos_con_Factores.rf, Datos_Test_con_Factores_Hombre[,-c(15)])
table.pred_Hombre.rf=table(pred_Hombre.rf,  as.factor(Datos_Test_con_Factores_Hombre[,15]))
print(table.pred_Hombre.rf)
...
datoNuevo <- data.frame(Age = 38, Workclass = "Private", fnlwgt = 125467, Education = "Bachelors", Education.num = 13, Marital.status = "Divorced", Occupation. = "Sales", Relationship = "Husband", Race = "White", Sex = " Male", Capital.gain = 1500, Capital.loss = 2000, Hours.per.week = 40, Native.country = "United-States", Income. = "< = 50K")
