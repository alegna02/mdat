...
Viendo las predicciones de cada modelo y analizando como son mediante la curva ROC podemos ver que el mejor modelo para las predicciones en nuestros datos es el Random Forest.

También, tras analizar los datos hemos visto, que si que son proporcionales tanto el nivel de educación como el trabajo que ejerzas con los ingresos. Sin embargo, hemos visto que el sexo no es influyente.
